...
export class SwipeScreen extends Component {
	...
	render() {
		console.log(this.props.arrayProfiles)			
		const {arrayProfiles, goToMatchScreen} = this.props
		...
		return (
			<SwipeScreenWrapper>
				...
				<ContentWrapper>
					...
					{arrayProfiles ? <UserSwipeCard
						arrayProfiles={arrayProfiles}
...
const mapStateToProps = (state) => ({	
		arrayProfiles: state.profiles.profiles		
