...
var ProductDataBase = /** @class */ (function (_super) {
    ...
    ProductDataBase.prototype.create = function (id, name, price, img) {
    ...
    ProductDataBase.prototype.getById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.connection().raw("\n            SELECT * FROM " + ProductDataBase.TABLE_NAME + " WHERE id = \"" + id + "\"\n        ")];
                    case 1:
                        result = _a.sent();
    ...
    ProductDataBase.TABLE_NAME = "Products";
